  ...
  1: {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "choice",
        prompt: {
          en: "Which of these can survive years without eating by going dormant?",
          pt: "Qual desses consegue sobreviver anos sem comer entrando em dormência?",
        },
        options: [
          {
            id: "a",
            text: { en: "A snail", pt: "Um caracol" },
            reaction: {
              en: "Correct — up to 3 years, believe it or not.",
              pt: "Correto — até 3 anos, acredite se quiser.",
            },
          },
          {
            id: "b",
            text: { en: "A bear", pt: "Um urso" },
            reaction: {
              en: "Close, but bears hibernate for months, not years.",
              pt: "Quase, mas ursos hibernam por meses, não anos.",
            },
          },
          {
            id: "c",
            text: { en: "A sloth", pt: "Uma preguiça" },
            reaction: { en: "Slow, but not that extreme.", pt: "Lento, mas não tanto assim." },
          },
          {
            id: "d",
            text: { en: "A tortoise", pt: "Uma tartaruga" },
            reaction: { en: "Long-lived, but not quite this trick.", pt: "Vive muito, mas não faz exatamente isso." },
          },
        ],
      },
      {
